						...
						<form className="space-y-6" onSubmit={handleSubmit} noValidate>
							...
							<div>
								...
								<Input
									...
									required
									className={`w-full p-3 border rounded-lg focus:ring-2 ${redirectUrlError
											? 'border-red-500'
											: 'border-gray-300'
							...
							<div className="mt-6">
								<Button
									type="submit"
									className={`bg-black text-white w-full py-3 rounded-full text-lg font-semibold hover:bg-gray-800 transition-all duration-300 ${(clientName === '' || redirectUrl === '' || redirectUrlError) &&
